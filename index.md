...
Ce colloque vise à analyser le rôle des sciences sociales dans la prévention, la médiation, la reconstruction post-conflit et la réconciliation.
Spécifiquement, il s’agira de :
1.	analyser les causes et dynamiques de ces conflits ;
...
5.	analyser les effets et impacts de ces conflits sur le développement socio-économique de l’Afrique subsaharienne.
...
***Des propositions regroupant d’autres aspects non indiqués dans ces axes mais permettant de discuter du rôle des sciences sociales dans la résolution des conflits en Afrique sub-saharienne sont également appréciables. Ces propositions ont trait par exemple aux technologies de l’Information.*** 
